...
void run_linked_list_tests(int num_samples, size_t sample_size){
    //Insert at the start benchmark
    printf("* Linked List Sequential Start\n");
    printf("  %ld ms\n", benchmark_function(linked_list_insert_sequential_start, num_samples, sample_size));

    //Insert at the end benchmark
    printf("* Linked List Sequential End\n");
    printf("  %ld ms\n", benchmark_function(linked_list_insert_sequential_end, num_samples, sample_size));

    //Insert at the random benchmark
    printf("* Linked List Random Insert\n");
...
int main(int argc, char **argv) {
    ...
    run_linked_list_tests(num_samples, sample_size);
